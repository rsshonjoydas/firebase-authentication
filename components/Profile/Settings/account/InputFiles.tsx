        ...
        <div className="space-y-1 text-center">
          ...
          <div className="flex justify-center text-sm text-gray-600">
            ...
            >
              Upload a file
              <input
                className="form-control sr-only block px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                type="file"
                id="formFileMultiple"
                accept=".jpg, .png, .gif"
                multiple
